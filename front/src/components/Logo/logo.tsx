                    ...
                    <defs>
                        ...
                        <linearGradient id="paint1_linear_134_2" x1="173" y1="0" x2="173" y2="276" gradientUnits="userSpaceOnUse">
                            <stop id="animatedStop1" offset="0%" stop-color="#FF1E1E">
                                <animate animation-direction="alternate" attributeName="stop-color" values="#71b7e6; #5f6265; #b436e6; #dd6557; #864e9c; #69a6ce; #71b7e6" dur="2s" repeatCount="indefinite" />
                            </stop>
                            <stop offset="95.3125%" stop-color="#FFCCCC">
                                <animate animation-direction="alternate" attributeName="stop-color" values="#71b7e698; #5f6265; #36e685; #cf2512; #864e9c; #69a6ce; #71b7e6" dur="2s" repeatCount="indefinite" />
                            </stop>
                        </linearGradient>
                        <linearGradient id="paint2_linear_134_2" x1="140.113" y1="0" x2="140.113" y2="284.022" gradientUnits="userSpaceOnUse" >
                            <stop id="animatedStop2" offset="0%" stop-color="#FE1D1D">
                                <animate animation-direction="alternate" attributeName="stop-color" values="#71b7e6; #5f6265; #b436e6; #cf2512; #864e9c; #69a6ce; #71b7e6" dur="2s" repeatCount="indefinite" from='100%' to="0%"/>
                            </stop>
                            <stop offset="100%" stop-color="#FFB1B1">
                                <animate animation-direction="alternate" attributeName="stop-color" values="#b436e6; #cf2512; #864e9c; #69a6ce; #b436e6" dur="2s" repeatCount="indefinite" from='100%' to="0%"/>
                            </stop>
                        </linearGradient>
                    </defs>
                </svg>
