...
export const NftRow = (props: { nftInfo: INFTRow, onClick: (e: MouseEvent, ca: string | undefined) => void }) => {
    const [modeState, setChange] = useGetMode()

    return (
        <RowWrap height={"7.2rem"} mode={modeState.mode} onClick={(e: MouseEvent) => props.onClick(e, props.nftInfo.ca)}>
