...
export const NftInfomation = ({ owner, blockchain, ca, tokenId, tokenStandard }: INftInfomation) => {
    ...
    return (
        <Board>
            ...
            <NftBoardContentRows info={{ owner, blockchain, ca, tokenId, tokenStandard }} open={isOpen} />
        </Board>
    )
}
