...
export const CoinInfo = (props: { coinInfo: ICoinInfo }) => {
    ...
    return (
        <CoinInfoWrap mode={modeState.mode}>
            ...
            <CoinInfoRow
                mode={modeState.mode}
                content={["현재가", props.coinInfo.price, props.coinInfo.currency, props.coinInfo.changePercent]}
            />
            <CoinInfoRow
                mode={modeState.mode}
                content={["BTC", props.coinInfo.price, "BTC", props.coinInfo.changePercent]}
            />
            <CoinInfoRow
                mode={modeState.mode}
                content={[
